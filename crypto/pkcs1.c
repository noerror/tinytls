...
static int pkcs1_generate_encryption_block(unsigned char block_type, unsigned int modlen, const unsigned char *in, unsigned int inlen, unsigned char *out, unsigned int *outlen)
{
    unsigned int ps_len;
    unsigned char *pos;
...
int pkcs1_decrypt_public_key(struct crypto_rsa_key *key,
	const unsigned char *crypt, unsigned int crypt_len,
